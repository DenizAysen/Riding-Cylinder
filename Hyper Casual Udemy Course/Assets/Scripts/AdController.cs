...
public class AdController : MonoBehaviour
{
    ...
    private float _interstitialAdTimer = 60f;
    ...
    public bool IsRaedyInterstitialAd()
    {
        if(_interstitialAdTimer < 0f && interstitial.IsLoaded())
        {
            return true;
        }
        return false;
